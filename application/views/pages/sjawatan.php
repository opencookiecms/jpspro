...
">
    <div class="row">
      ...
      <div class="col-12 grid-margin">
        ...
        <?php
          echo form_open('Setting_con/getjawatan');
        ?>
    ...
    <div class="card" style="border-radius:10px;">
          <div class="card-body">
            ...
            <a href="<?php echo site_url('Setting_con/getjawatan') ?>" class="btn btn-dark mr-2 btn-rounded" role="button">Senarai Jawatan</a>
            ...
            <p></p>
            <p></p>
            <h4 class="card-title">Konfigurasi maklumat sistem (Jawatan)</h4>
              <div class="row">
                <div class="col-md-4">
                <label>Jawatan</label>
                  <input class="form-control" name="jawatan" id="people" placeholder="Jawatan">
                </div>
              </div>
              <p>
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <col style="width: 120px">
                    ...
                    <thead>
                      ...
                      <th class="tg-hgcj">Jawatan</th>
             
                      <th class="tg-hgcj">Tindakan</th>
                    </thead>
                    <?php $bil=0;?>
                <?php foreach ($get_jawatansetting as $row): $bil++ ?>

                    <tr>
                      <td class="tg-baqh"><?php echo $bil ?></td>
                      <td class="tg-baqh"><?php echo $row->jw_jawatan?></td>
                  
                      <td class="tg-baqh"> <a href="<?php echo site_url("Setting_con/deljawatan/".$row->jw_id); ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" role="button" onclick="return confirm('Anda pasti?')"><i class="menu-icon mdi mdi-delete-circle"></i></a></td>
                    </tr>
