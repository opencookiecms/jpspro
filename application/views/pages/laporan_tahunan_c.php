...
">
          <div class="row">
            ...
            <div class="col-9 grid-margin">
              ...
              <?php echo form_open('Report/Laporan_Tahunan'); ?>
                  ...
                  <h4 class="card-title tl">Pendaftaran No Perolehan</h4>
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          <div class="col-sm-3">
                            ...
                            <select type="text" class="form-control" name="year" placeholder="">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <div class="col-sm-3">
                            <button type="submit" name="submit" class="btn btn-success mr-2 btn-rounded ">Proses Laporan</button>
                          </div>
                        </div>
                      </div>
                    </div>
