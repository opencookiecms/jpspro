          ...
          <div class="row">
            <div class="col-lg-12 grid-margin">
              <div class="card" style="border-radius:10px;">
                <div class="card-body">
                  <h4 class="card-title">Senarai Projek <?php echo $y ?></h4>
                      ...
                      <tbody>
                        ...
                        ?>
                         <tr>
                          ...
                          <?php echo '<div class="progress-bar bg-'.$color.' progress-bar-striped" role="progressbar" style="width:'.number_format($per,1).'%" aria-valuenow="'.number_format($per).'" aria-valuemin="0" aria-valuemax="100">'.number_format($per,1)."%".'</div>' ?>
