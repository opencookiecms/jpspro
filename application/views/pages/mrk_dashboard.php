    ...
    <div class="row purchace-popup">
      <div class="col-12">
        <span class="d-block d-md-flex align-items-center">
          <p class="tls text-white">Dokumen & Surat-Menyurat.</p>
        </span>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 grid-margin stretch-card">
        <div class="card card-statistics" style="border-radius:10px;">
          <div class="card-body">
            <div class="clearfix">
              <div class="float-left">
                <i class="mdi mdi-folder-multiple-outline text-success icon-lg"></i>
              </div>
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">LSK</h3>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">PSK</h3>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">SS</h3>
                </div>
              </div>
            </div>
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 grid-margin stretch-card">
        <div class="card card-statistics" style="border-radius:10px;">
          <div class="card-body">
            <div class="clearfix">
              <div class="float-left">
                <i class="mdi mdi-ambulance text-info icon-lg"></i>
              </div>
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">PSMK</h3>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">PJB</h3>
                </div>
              </div>
            </div>
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 grid-margin stretch-card">
        <div class="card card-statistics" style="border-radius:10px;">
          <div class="card-body">
            <div class="clearfix">
              <div class="float-left">
                <i class="mdi mdi-tag text-success icon-lg"></i>
              </div>
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">PP WJP</h3>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">MRK</h3>
                </div>
              </div>
            </div>
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 grid-margin stretch-card">
        <div class="card card-statistics" style="border-radius:10px;">
          <div class="card-body">
            <div class="clearfix">
              <div class="float-left">
                <i class="mdi mdi-image-filter-frames text-success icon-lg"></i>
              </div>
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">S.Khas</h3>
                </div>
              </div>
            </div>
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 grid-margin stretch-card">
        <div class="card card-statistics" style="border-radius:10px;">
          <div class="card-body">
            <div class="clearfix">
              <div class="float-left">
                <i class="mdi mdi-memory text-info icon-lg"></i>
              </div>
              <div class="float-right">
                <p class="mb-0 text-right">Dokumen</p>
                <div class="fluid-container">
                  <h3 class="font-weight-medium text-right mb-0">Surat</h3>
                </div>
              </div>
            </div>
