          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                foreach ($get_suratmrk as $row) {
                  ?>

                 <tr>
                  <td><?php echo $row->id?></td>
                  <td><a href="#" ><?php echo $row->mrk_rujuktuan?></a></td> <!--Show data in list view-->
                  <td><?php echo $row->mrk_tarikhtuan?></td>
                  <td><?php echo $row->mrk_rujukkami?></td>
                  <td><?php echo $row->mrk_jenisborang?></td>
                  <td><?php echo $row->mrk_namakon?></td>
                  <td><?php echo $row->mrk_nokon?></td>
